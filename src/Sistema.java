public class Sistema {
    public static void imprimirMenu(String nomeMenu) {
        if (nomeMenu == "Principal") {
            ...
            System.out.println("= Digite 'Conta' para visualizar opcoes de conta    =");
            System.out.println("=====================================================");
            System.out.print("Sua opcao: ");
        }
        if (nomeMenu == "Categoria1") {
            System.out.println("=====================================================");
